        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="text-xl font-bold text-[#1E1B4B]">
              Stud<span className="text-purple-500">do</span>
            </span>
          </Link>
          ...
          {/* Mobile menu button */}
          <button
            className="md:hidden text-gray-500 hover:text-[#1E1B4B] p-2"
          ...
          <div className="px-4 py-4 space-y-3">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="block text-gray-500 hover:text-[#1E1B4B] py-2"
