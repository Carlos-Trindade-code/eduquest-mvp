  ...
  return (
    <div className="min-h-screen bg-gradient-app">
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 space-y-6">
        {/* Invite Code Card - always visible for parents */}
        {inviteCode && (
          <InviteCodeCard code={inviteCode} hasKids={kids.length > 0} />
        )}
              ...
              <motion.button
                ...
                className={cn(
                  ...
                  selectedKid?.id === kid.id
                    ? 'bg-[var(--eq-primary)] text-white shadow-lg'
                    : 'glass text-[var(--eq-text-secondary)] hover:text-white'
                )}
              >
                {kid.name}
              </motion.button>
